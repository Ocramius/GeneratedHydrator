...
Here's an example of how you can create and use a hydrator generated by GeneratedHydrator:
...
A hydrator generated by GeneratedHydrator is very fast.
Here's the performance of the various hydrators of `Zend\Stdlib\Hydrator` compared to a GeneratedHydrator's generated proxy:
...
See [Tuning GeneratedHydrator for Production](https://github.com/Ocramius/GeneratedHydrator/blob/master/docs/tuning-for-production.md).
